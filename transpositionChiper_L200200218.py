#------------------------[ FUNGSI PROSES ENKRIPSI TRANSPOSITION CHIPER]------------------------
...
#------------------------[ FUNGSI PROSES DEKRIPSI TRANSPOSITION CHIPER]------------------------
...
#------------------------[ FUNGSI MENJALANKAN PROSES ENKRIPSI DEKRIPSI TRANSPOSITION CHIPER ]------------------------
def main():
    print("-----------------------------------------------------")
