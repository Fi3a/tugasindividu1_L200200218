#-------------------[ FUNGSI PROSES ENKRIPSI VIGENERE CHIPER]-------------------
...
#-------------------[ FUNGSI PROSES DEKRIPSI VIGENERE CHIPER]-------------------
...
#-------------------[ FUNGSI MENJALANKAN PROSES ENKRIPSI DEKRIPSI VIGENERE CHIPER ]-------------------
def main():
    print("-----------------------------------------------------")
    print("=== [ PROSES ENKRIPSI DEKRIPSI VIGENERE CHIPER ] ====")
    print("-----------------------------------------------------")
    pesan = input('Isi Pesan      : ')  
    kunci = ('218') #NIM saya L200200218 (3 digit terakhir)
